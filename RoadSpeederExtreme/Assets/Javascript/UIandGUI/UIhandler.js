...
public class UIhandler extends MonoBehaviour {
    ...
    {
        for (var messageObject: var in scoreMessagesList)
        {
    ...
    private function UpdateUiElements(): IEnumerator
    {
        while (true)
        {
            ...
            {
                speedPercentage = parseFloat(GameControllerScript.playerSpeed) / parseFloat(GameControllerScript.maxPlayerSpeed) * 100;
